...
<head>
    ...
    <link rel="stylesheet" href="ercss/alumno.css">
    <script type="text/javascript" src="js/jquery.js"></script> 
    <script type="text/javascript" src="js/bootstrap.js"></script>
    <title>UMG Evaluacion Docenter</title>
			...
			<div class="col-md-4">
			    <div class="thumbnail">
			    	<a data-toggle="modal" href='#inscribir'>
			      		<img src="icon/evaluar.png" width="100px;"></a>
			      			<center><h3>Evaluar Docente</h3></center>
			    </div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">	
					<div class="container"><br>
						<div class="col-md-2">
							<a href="basico.php">
								<button type="button" class="btn btn-info btn-lg" >Compiladores</button>
							</a>	
						</div>	
						<div class="col-md-2 col-offset-md-4">
							<a href="primaria.php">
								<button type="button" class="btn btn-success  btn-lg" >Algoritmos AG</button>
							</a>
						</div>	
						<div class="col-md-2">
							<a href="preprimaria.php">
								<button type="button" class="btn btn-danger btn-lg">Fisica Experimental</button>
							</a>
						</div>
					</div><br>
				</div>
